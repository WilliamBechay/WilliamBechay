...
// La grille est TOUJOURS visible (pas de toggle) : un AnimatePresence
// conditionnel avait été testé mais réintroduisait du montage/démontage
// coûteux à chaque clic — retiré pour rester sur ce pattern optimisé.
